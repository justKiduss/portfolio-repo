...
export default function SignupForm() {
    ...
    return(
        <>
            <form onSubmit={handleSubmit} className="h-screen flex items-center justify-center bg-gray-100 dark:bg-black transition-colors">
                <div className="w-96 p-6 bg-white dark:bg-zinc-900 rounded-lg shadow-md border dark:border-zinc-800">
                    ...
                    <button type="submit" className="w-full bg-black text-white py-2 rounded mt-4 dark:bg-white dark:text-black font-semibold hover:opacity-90 transition-all"> Sign Up</button>
                    <p className="text-sm text-center my-4 dark:text-zinc-400">Already have an account? {" "} 
