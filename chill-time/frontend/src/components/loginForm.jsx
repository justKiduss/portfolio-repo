...
export function LoginForm() {
  ...
  return (
    <div className="h-screen flex items-center justify-center bg-gray-100 dark:bg-black transition-colors">
      <div className="w-96 p-6 bg-white dark:bg-zinc-900 rounded-lg shadow-md border border-transparent dark:border-zinc-800">
        ...
        <form onSubmit={handleSubmit}>
          ...
          <div className="text-right mb-4">
            <a href="/forgot-password" className="text-sm text-cyan-600 hover:underline dark:text-[#2DE2C1]">
              Forgot your password
            </a>
          </div>
          <button
            className="w-full bg-black text-white py-2 rounded mb-2 dark:bg-white dark:text-black font-semibold hover:opacity-90 transition-opacity"
            type="submit"
          >
            Login
          </button>
        ...
        <button
          className="w-full border py-2 rounded mb-4 dark:border-zinc-700 dark:text-white dark:hover:bg-zinc-800 transition-colors"
          onClick={handleGoogleLogin}
        >
          Login with Google
        </button>

        <p className="text-sm text-center dark:text-zinc-400">
          Don't have an account?{" "}
          <a href="/signup" className="text-cyan-600 hover:underline dark:text-[#2DE2C1]">
            Sign up
          </a>
        </p>
      </div>
