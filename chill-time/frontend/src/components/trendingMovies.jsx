...
export default function TrendingMovies() {
  ...
  return (
    <div className="p-4 md:p-10 max-w-[1800px] mx-auto">
      <SectionHeader label="Right now" title="Trending" />
      {/*
        auto-fill + minmax instead of fixed grid-cols:
        - cards stay ~180px+ regardless of screen width (no more ballooning on big monitors)
        - unused grid tracks stay empty rather than stretching to fill sparse rows,
          so a short list of movies doesn't distort into a few huge cards
      */}
      <div
