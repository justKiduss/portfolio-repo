            ...
            <div className="h-screen flex items-center justify-center bg-gray-100 dark:bg-black transition-colors">
                <div className="w-96 p-6 bg-white dark:bg-zinc-900 rounded-lg shadow-md border dark:border-zinc-800">
                    ...
                    <div className="flex flex-col gap-2 mb-4">
                        ...
                        <input type="text" className="border p-2 rounded focus:outline-none focus:ring-2 focus:ring-blue-500 dark:bg-zinc-800 dark:border-zinc-700 dark:text-white transition-colors"/>
                    </div>

                    <div className="flex flex-col gap-2 mb-2">
                        <label className="text-sm font-medium dark:text-zinc-300">Email</label>
                        <input type="email" className="border p-2 rounded focus:outline-none focus:ring-2 focus:ring-blue-500 dark:bg-zinc-800 dark:border-zinc-700 dark:text-white transition-colors"/>
                    </div>

                    <div className="flex flex-col gap-2 mb-2">
                        <label className="text-sm font-medium dark:text-zinc-300">Password</label>
                        <input type="password" className="border p-2 rounded focus:outline-none focus:ring-2 focus:ring-blue-500 dark:bg-zinc-800 dark:border-zinc-700 dark:text-white transition-colors"/>
                    </div>

                    <button className="w-full bg-black text-white py-2 rounded mt-4 dark:bg-white dark:text-black font-semibold hover:opacity-90 transition-all"> Sign Up</button>
